...
<h2>[ML] 이탈 예측 · Snowflake 환경 실습</h2>
...
### D7 이탈 예측 혼동 행렬
![confusion matrix]([ML] 이탈 예측 · Snowflake 환경 실습/confusion_matrix.png)

---

<h2>[시각화] Tableau 대시보드 구축</h2>
